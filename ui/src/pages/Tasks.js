          ...
          <div class=" items-center">
            <div class="relative inline-block h-4 w-8 cursor-pointer rounded-full">
              <input
                ...
                id="switch-component"
                type="checkbox"
                class="peer absolute h-4 w-8 cursor-pointer rounded-full bg-blue-gray-300 transition-colors duration-300 checked:bg-pink-500 peer-checked:border-pink-500 peer-checked:before:bg-pink-500"
