...
Votre collègue de travail soummet une *merge (ou pull) request* et il vous assigne en tant que *reviewer* principal. C'est donc à vous de relire son code et de détecter les mauvaises odeurs possiblent en considérant aussi les mauvaises pratiques du cadriciel Angular.

a) 
```
/// Ce code provient d'un projet Angular écrit en Typescript
